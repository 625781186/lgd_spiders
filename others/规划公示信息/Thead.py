...
def set_redis():
    ...
    urls = [url_jm.format(i) for i in range(1, 75)] \
           + [url_xh.format(i) for i in range(1, 75)] \
           + [url_ts.format(i) for i in range(1, 53)] \
           + [url_kp.format(i) for i in range(1, 53)] \
           + [url_ep.format(i) for i in range(1, 16)] \
           + [url_hs.format(i) for i in range(1, 44)]
